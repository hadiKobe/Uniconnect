...
<Card>
  ...
  <div className="flex-shrink-0 flex justify-center sm:block">
    <Avatar className="h-24 w-24 sm:h-32 sm:w-32">
      <AvatarImage src={student.profile_picture || "/placeholder.svg"} alt={student.first_name} />
  ...
  <div className="flex-1 space-y-4">
    ...
    <div className="flex flex-col gap-2 text-sm text-muted-foreground">
      <div className="flex items-center gap-2">
        ...
        <span>
          {student.major || "Undeclared"} • {student.graduation_progress ?? "N/A"} • GPA:{" "}
  ...
  {/* Right: Buttons */}
  <div className="flex flex-col gap-2 sm:items-end sm:justify-start w-full sm:w-auto">
    {isCurrentUser ? (
